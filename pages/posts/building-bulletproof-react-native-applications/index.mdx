...
```ts filename="./src/types/index.d.ts"
declare global {
  type MyType = {
    name: string;
    //...
...
<FileTree>
  <FileTree.Folder name="src" defaultOpen>
    ...
    <FileTree.Folder name="views" defaultOpen>
      ...
      <FileTree.Folder name="ScreenOne" defaultOpen />
      <FileTree.Folder name="ScreenTwo" defaultOpen />
    </FileTree.Folder>
    <FileTree.File name="bootstrap.tsx" />
  </FileTree.Folder>
</FileTree>
...
```tsx filename="./src/bootstrap.tsx"
...
```json filename="./scgorc.json"
{ "plugins": [{ "removeViewBox": false }] }
 // viewboxu kaldırmak için plugin kullandık
```
...
```ts filename="./src/style/fonts.ts"
...
```ts filename="./api/services/Cars.ts"
...
```tsx filename="./views/Cars/index.tsx"
...
```ts filename="./store/user.slice.ts"
