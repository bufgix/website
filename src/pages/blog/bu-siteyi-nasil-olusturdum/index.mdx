...
> Bu yazi artik gecerli degil. Kisisel sitemi [Astro](https://astro.build/) ile yeniden olusturdum.
...
```ts title="/routes/api/bookmarks.json.ts"
...
```svelte title="/routes/bookmarks.svelte"
